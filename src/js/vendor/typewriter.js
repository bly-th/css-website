      ...
      var O = (function () {
        function e(t, n) {
          ...
          if (
            ...
            _(this, 'state', { cursorAnimation: null, lastFrameTime: null, pauseUntil: null, eventQueue: [], eventLoop: null, eventLoopPaused: !1, reverseCalledEvents: [], calledEvents: [], visibleNodes: [], initialOptions: null, elements: { container: null, wrapper: document.createElement('span'), cursor: document.createElement('span') } }),
            _(this, 'options', { strings: null, cursor: '|', delay: 'natural', pauseFor: 1500, deleteSpeed: 'natural', loop: !1, autoStart: !1, devMode: !1, skipAddStyles: !1, wrapperClassName: 'Typewriter__wrapper', cursorClassName: 'Typewriter__cursor', stringSplitter: null, onStringTyped: null, onStringType: null, onCreateTextNode: null, onRemoveNode: null }),
            ...
            _(this, 'afterTypeCallback', function (e) {
              return null !== e && 'function' == typeof e && u.callFunction(e), u;
            }),
            _(this, 'typeOutAllStrings', function () {
              return 'string' == typeof u.options.strings
                ? (u.typeString(u.options.strings).afterTypeCallback(u.options.onStringTyped).pauseFor(u.options.pauseFor), u)
                : (u.options.strings.forEach(function (e) {
                    u.typeString(e).afterTypeCallback(u.options.onStringTyped).pauseFor(u.options.pauseFor).deleteAll(u.options.deleteSpeed);
                  }),
                  u);
            }),
            ...
            _(this, 'pasteString', function (e) {
              var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
              return i(e) ? u.typeOutHTMLString(e, t, !0) : (e && u.addEventToQueue(T, { character: e, node: t }), u);
            }),
                  ...
                  switch ((u.logInDevMode({ currentEvent: r, state: u.state, delay: i }), a)) {
                    ...
                    case c:
                      var C = b.character,
                        ...
                        O = _;
                      u.options.onCreateTextNode && 'function' == typeof u.options.onCreateTextNode && (O = u.options.onCreateTextNode(C, _)), O && (N ? N.appendChild(O) : u.state.elements.wrapper.appendChild(O)), (u.state.visibleNodes = [].concat(S(u.state.visibleNodes), [{ type: E, character: C, node: O }]));
                      break;
                    case l:
                    ...
                    case h:
                      var D = r.eventArgs,
                        k = D.node,
                        P = D.parentNode;
                      P ? P.appendChild(k) : u.state.elements.wrapper.appendChild(k), (u.state.visibleNodes = [].concat(S(u.state.visibleNodes), [{ type: w, node: k, parentNode: P || u.state.elements.wrapper }]));
                      break;
                    case p:
                    ...
                    case d:
                      ...
                      if (u.state.visibleNodes.length) {
                        var q = u.state.visibleNodes.pop(),
                          ...
                          Y = q.node,
                          V = q.character;
                        u.options.onRemoveNode && 'function' == typeof u.options.onRemoveNode && u.options.onRemoveNode({ node: Y, character: V }), Y && Y.parentNode.removeChild(Y), G === w && U && n.unshift({ eventName: d, eventArgs: {} });
                      }
                      break;
                    case m:
